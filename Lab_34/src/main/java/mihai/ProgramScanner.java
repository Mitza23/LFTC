...
public class ProgramScanner {
    ...
    String delimiters = " ;()[]{}";
    FiniteAutomaton constantsAutomaton;
    FiniteAutomaton identifiersAutomaton;



    public ProgramScanner(String tokensFile, String constantsFile, String identifiersFile) {
        this.tokensFile = tokensFile;
        tokens = new ArrayList<>();
        pif = new ArrayList<>();
        symbolTable = new ArrayList<>();
        constantsTable = new ArrayList<>();
        constantsAutomaton = new FiniteAutomaton(constantsFile);
        identifiersAutomaton = new FiniteAutomaton(identifiersFile);
...
//        return token.matches("[a-zA-Z]+[a-zA-Z0-9]*");
        return identifiersAutomaton.checkSequence(token, identifiersAutomaton.getInitialStates());
    }
...
//        return token.matches("\"[a-zA-Z0-9]+\"|\'[a-zA-Z0-9]\'|[0-9]|[1-9][0-9]*");
        return constantsAutomaton.checkSequence(token, constantsAutomaton.getInitialStates());
    }
